...
def parse():
    ...
    init_parser.add_argument('-a', '--author', type=str, default=None)
    init_parser.add_argument('-e', '--email', type=str, default=None)
    ...
    init_parser.add_argument('-r', '--remote', type=str, default=None)
    init_parser.add_argument('-d', '--description', type=str, default="no description", dest="desc")
    init_parser.add_argument('--venv-name', type=str, default='.venv')
    ...
    new_parser.add_argument('-a', '--author', type=str, default=None)
    new_parser.add_argument('-e', '--email', type=str, default=None)
    ...
    new_parser.add_argument('-r', '--remote', type=str, default=None)
    new_parser.add_argument('-d', '--description', type=str, default="no description", dest="desc")
    new_parser.add_argument('--venv-name', default='.venv')
